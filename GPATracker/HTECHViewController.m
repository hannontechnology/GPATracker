...
- (IBAction)Login:(id)sender
{
    ...
    request.predicate = [NSPredicate predicateWithFormat:@"userName = %@ and userPassword = %@", userNameField.text, passwordField.text];
    NSLog(@"filtering data based on userName = %@ and userPassword = %@", userNameField.text, passwordField.text);
